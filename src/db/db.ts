...
export const seedDatabase = async () => {
  const modules = [
    ...
    { id: 'safety-1', type: 'safety', title: 'Spot the Scam', description: 'Learn how to identify phishing emails and unsafe links.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-2', type: 'safety', title: 'Protect Your Password', description: 'Learn how to create strong passwords.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-3', type: 'safety', title: 'Social Media Safety', description: 'Sharing safely on the internet.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-4', type: 'safety', title: 'Privacy Settings', description: 'Understanding who can see your information.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-5', type: 'safety', title: 'Cyberbullying', description: 'How to stay kind and safe online.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-6', type: 'safety', title: 'Safe Searching', description: 'How to find the right information safely.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-7', type: 'safety', title: 'Digital Footprint', description: 'Understand what you leave behind online.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' },
    { id: 'safety-8', type: 'safety', title: 'Fake News', description: 'How to spot misinformation online.', video_url: 'https://www.youtube.com/embed/zALlsJgE9D0' }
  ];
